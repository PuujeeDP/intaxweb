{{-- Social Links Widget --}}
<div class="widget widget-social mb-6" data-widget-key="{{ $widget->key }}">
    <div class="flex space-x-3">
        @if(!empty($widget->content['facebook']))
            <a href="{{ $widget->content['facebook'] }}" target="_blank" rel="noopener"
        ...
        @if(!empty($widget->content['twitter']))
            <a href="{{ $widget->content['twitter'] }}" target="_blank" rel="noopener"
        ...
        @if(!empty($widget->content['instagram']))
            <a href="{{ $widget->content['instagram'] }}" target="_blank" rel="noopener"
        ...
        @if(!empty($widget->content['linkedin']))
            <a href="{{ $widget->content['linkedin'] }}" target="_blank" rel="noopener"
